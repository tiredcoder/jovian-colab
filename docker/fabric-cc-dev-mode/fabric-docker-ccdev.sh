...
# Get the config
source "$SCRIPT_DIR/fabric-docker/.env"
...
case "$ACTION" in
  ...
  "invoke")
    ...
    CC_INVOKE_DEFAULT_ARGS='{"Args":["createData","filetest", "pnet0", "cid", "cipher", "cryptkey", "{\"Users\":{},\"MSPs\":{\"SampleOrg\":\"r\"}}"]}'
    #CC_INVOKE_DEFAULT_ARGS='{"Args":["readData", "peer0.fabric-ccdev.localhost@SampleOrg/filetest"]}'
    #CC_INVOKE_DEFAULT_ARGS='{"Args":["listAllData"]}'
    #CC_INVOKE_DEFAULT_ARGS='{"Args":["deleteData", "peer0.fabric-ccdev.localhost@SampleOrg/filetest"]}'
    #CC_INVOKE_DEFAULT_ARGS='{"Args":["createData","filetest", "pnet0", "CHANGED CID", "cipher", "cryptkey", "{\"Users\":{},\"MSPs\":{\"SampleOrg\":\"r\"}}"]}'
    #CC_INVOKE_DEFAULT_ARGS='{"Args":["listDataHistory","peer0.fabric-ccdev.localhost@SampleOrg/filetest"]}'
