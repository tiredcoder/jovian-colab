#!/usr/bin/env bash
# Generated by Fablo and *heavily* modified by Rik Janssen
set -eu
...
source "$FABLO_NETWORK_ROOT/fabric-docker/commands.sh"
...
if [ "$1" = "up" ]; then
  ...
  echo "To list channel query helper commands type: './fabric-docker.sh channel --help'"
